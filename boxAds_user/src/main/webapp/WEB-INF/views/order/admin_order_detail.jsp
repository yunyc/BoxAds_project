					...
					<div class="left_cnt">
						<div class="box_wrap box_box pos_top">
							<div class="box_area02">
								...
								<div class="text_box">
									...
									<a href="${box.url}" class="link">${box.url}</a>
									</div>
						...
						<div class="box_wrap ads_box">
							<div class="box_area02">
								...
								<div class="text_box">
									<span class="small_tit"><em>${ad.adCode}</em></span>
					...
					<div class="right_cnt">
						<div class="payment_wrap">
							<div class="order_sum_wrap">
								...
								<p class="order_txt">${insertDate} : <strong>${order.insertDate}</strong></p>
							</div>
							<div class="num_wrap">
								<div class="num_list">									
									<dl>
							...
							<div class="info_result">
								...
								<div class="btn_area">
									<a href="../member/message_detail?writer=${login.idx}&receiver=${ad.writer}" class="btn btn_chat"><span>채팅문의</span></a>
